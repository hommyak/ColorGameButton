...
namespace GameColorV002
{
    public class GridClass
    {
        ...
        public AbsoluteLayout StartingGRC(int sizeMTR, int countColors, bool tasks, string newTask)
        {
            moveByX = 0;
            moveByY = 0;
           ...
           ImageButton mainmenu = new ImageButton()
            ...
            {
                _task = newTask;
                Label lbtask = new Label() { FontFamily = "Arial", FontSize = 19, BackgroundColor = Color.FromHex("3D355F"), TextColor = Color.FromHex("FFDE40"), VerticalTextAlignment = TextAlignment.Center, HorizontalTextAlignment = TextAlignment.Center };
                ...
                lbtask.Text = _task;
                _mainPlace.Children.Add(lbtask, new Rectangle(0.95, 0.3, 0.4, 0.45), AbsoluteLayoutFlags.All);
                //_mainPlace.Children.Add(AdminButton, new Rectangle(0.95, 0, 0.075, 0.125), AbsoluteLayoutFlags.All);
            }

            _mainPlace.Children.Add(_centerPlace._griding, new Rectangle(0.03, 0.25, 0.55, 0.95), AbsoluteLayoutFlags.All);
